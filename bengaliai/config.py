...
TRAIN = [
    os.path.join(DATA_DIR, "bengaliai-cv19", "train_image_data_0.parquet"),
...
TEST = [
    os.path.join(DATA_DIR, "bengaliai-cv19", "test_image_data_0.parquet"),
...
label_names = ["grapheme_root", "vowel_diacritic", "consonant_diacritic"]
